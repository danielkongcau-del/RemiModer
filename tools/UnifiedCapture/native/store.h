...
class Store {
    static constexpr uint64_t MaxOutstandingSealBytes=64ull<<20;
    ...
    std::atomic<uint64_t> eventTotal{0},sealedChunks{0},storedTotal{0},rawTotal{0},flushTicks{0};
    ...
    struct SealJob {uint64_t chunk=0,minId=UINT64_MAX,maxId=0,minQpc=UINT64_MAX,maxQpc=0,count=0;Bytes payload;};
