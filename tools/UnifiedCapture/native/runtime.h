...
class Runtime {
    ...
    std::atomic<bool> admitting{false},stopRequested{false};
    std::atomic<uint64_t> entrants{0},eventIds{1},callIds{1};
    ...
    bool clean=false,moduleInvalid=false;uint64_t lastModuleCheck=0;
